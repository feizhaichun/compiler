	...
	try:
		...
		test_cases = [
			...
			[
				...
				'''],
				"( Foo None [( ( x ) = ( ( y ) = ( 3 ) ) ), ( a [] ( ( ( x ) += ( 3 ) ) ( x ) ) ), ( b [i] ( ( ( x ) + ( i ) ) ) )] )"
			],
			[
				['''
				foo = Foo()
		...
		test_cases = [
			...
			[
				...
				'''],
				[
					'None', "Foo : (class : Foo, local_env : a : (Func : a), b : (Func : b), this : this, x : 3, y : 3,),"
				],
			],
			[
				['''
				...
				'''],
				[
					'None', "Foo : (class : Foo, local_env : a : (Func : a), b : (Func : b), this : this, x : 3, y : 3,), f : (InstanceInfo [class_name : Foo, local_env : "
					"this : this,, ]),"
				],
			],
			[
			...
			[
				...
				'''],
				[
					'None', "Foo : (class : Foo, local_env : a : (Func : a), b : (Func : b), this : this, x : 3, y : 3,), a : 13, f : (InstanceInfo [class_name : Foo, "
					"local_env : this : this,, ]),"
				],
			],
		]
